...
export class ProviderMock {
    constructor() {
        ...
        this.features = [
            ...
            { id:'feat-beta-C-followup', type:'feature', parentEpic:'epic-beta-1', title:'Failover Validation', project:'beta', start:'2025-09-16', end:'2025-09-30', teamLoads:[{team:'devops', load:5}], status:'New', assignee:'Hank', description:'Validation tasks.', azureUrl:'#', dependsOn:['feat-beta-C'] },
            ...
            { id:'feat-alpha-A-sub', type:'feature', parentEpic:'epic-alpha-1', title:'Onboarding Email', project:'alpha', start:'2025-02-01', end:'2025-02-10', teamLoads:[{team:'frontend', load:20}], status:'New', assignee:'Clara', description:'Email task.', azureUrl:'#', dependsOn:['feat-alpha-A'] },
