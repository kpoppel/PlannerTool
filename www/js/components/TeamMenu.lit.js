          ...
          ${teams.map((team) => {
            ...
            return html`
              <li class="sidebar-list-item">
                <div
                  class="chip sidebar-chip ${team.selected ? 'active' : ''}"
                  @click=${(e) => {
                    if (!e.target.closest('.color-dot')) this._toggleTeam(team.id);
                  }}
                ...
                >
                  ...
                  >
                    ${team.name}${team.short ?
                      html` <span class="team-short">(${team.short})</span>`
                    : ''}
                  </div>
                  <div
