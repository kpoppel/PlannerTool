      ...
      <modal-lit wide>
        ...
        <div class="content">
          <div>
            ...
            <div class="steps">
              <div class="step">
                A tool that extracts Epics and Features from Azure DevOps and visualises
                them for strategic planning. It is not a second database.
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="steps">
              <div class="step">
                Github: kpoppel as a passion project. Report bugs or request improvements
                on
                <a
                  href="https://github.com/kpoppel/PlannerTool"
                  target="_blank"
                  rel="noopener"
                  >GitHub</a
                >.
          ...
          <div>
            ...
            <div class="steps">
              ...
              <div class="step">
                ...
                email and paste the PAT, then Save. Refresh the browser.
              </div>
            </div>
          </div>
          ...
          <div style="margin-top:12px; font-size:13px; color:#444">
            Play around — you can change anything and try features freely.
          </div>
        </div>
        <div slot="footer" class="modal-footer">
          <div>
            <button class="secondary" @click=${this._dontShowAgain}>
              Don't show again
            </button>
          </div>
          <div class="right">
