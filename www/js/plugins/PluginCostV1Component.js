 ...
 *
 * Dependencies: `PluginCostV1Calculator` helpers, `state` service, `dataService`.
 */
...
export class PluginCostV1Component extends LitElement {
  static properties = {
    data: { state: true },
    months: { state: true },
    projects: { state: true },
  ...
  open() {
    // Plugin's parent (PluginCostV1.js) handles display and timeline-board hiding
    // Just load the data
    this._subscribe();
...
customElements.define('plugin-cost-v1', PluginCostV1Component);
