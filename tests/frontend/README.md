...
Modules with significant DOM/UI logic (e.g., modal.js, sidebar.js, detailsPanel.js, dragManager.js, featureCard.js, timeline.js, mainGraph.js, loadMath.js, app.js) are less suitable for pure console tests and may require browser or DOM mocks.
