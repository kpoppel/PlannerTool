...
const tasksPayload = [
  // 1. Epic top-level, Feature child, same project -> OK
  {
    ...
    areaPath: 'ProjectA\\Team1',
    iterationPath: 'ProjectA',
    relations: [],
    url: 'https://example/100',
    project: 'project-projecta',
    start: '2025-01-01',
    end: '2025-06-30',
    capacity: [{ team: 'team-team1', capacity: 80 }],
  },
  {
    id: 101,
    type: 'feature',
    title: 'Feature child same',
    assignee: 'Bob',
    state: 'Active',
    tags: 'Feature',
    ...
    areaPath: 'ProjectA\\Team1',
    iterationPath: 'ProjectA',
    relations: [{ type: 'Parent', id: 100, url: 'https://example/100' }],
    url: 'https://example/101',
    project: 'project-projecta',
    start: '2025-02-01',
    end: '2025-03-01',
    capacity: [{ team: 'team-team1', capacity: 40 }],
  },
  ...
  },
  {
    id: 201,
    type: 'feature',
    title: 'Feature child cross',
    assignee: 'Dan',
    state: 'Active',
    tags: 'Feature',
    description: 'Cross-area feature',
    startDate: '2025-02-10',
    finishDate: '2025-03-10',
    areaPath: 'ProjectB\\Team2',
    iterationPath: 'ProjectB',
    relations: [{ type: 'Parent', id: 200, url: 'https://example/200' }],
    url: 'https://example/201',
    project: 'project-projectb',
    start: '2025-02-10',
    end: '2025-03-10',
    capacity: [{ team: 'team-team2', capacity: 30 }],
  },
  ...
  // 3. Epic_1 -> Feature_1 -> Epic_2 -> Feature_2 (nested alternating types) -> 302 and 301 not connected. Size and move as separate pairs.
  {
    ...
    capacity: [{ team: 'team-team1', capacity: 90 }],
  },
  {
    id: 301,
    type: 'feature',
    ...
    state: 'Active',
    tags: 'Feature',
    description: 'Nested feature 1',
    startDate: '2025-03-15',
    finishDate: '2025-04-15',
    areaPath: 'ProjectA\\Team1',
    iterationPath: 'ProjectA',
    relations: [{ type: 'Parent', id: 300, url: 'https://example/300' }],
    url: 'https://example/301',
    project: 'project-projecta',
    start: '2025-03-15',
    end: '2025-04-15',
    capacity: [{ team: 'team-team1', capacity: 45 }],
  },
  {
    id: 302,
    type: 'epic',
    ...
    state: 'New',
    tags: 'Epic',
    description: 'Nested epic 2',
    startDate: '2025-04-01',
    finishDate: '2025-06-01',
    areaPath: 'ProjectA\\Team1',
    iterationPath: 'ProjectA',
    relations: [{ type: 'Parent', id: 301, url: 'https://example/301' }],
    url: 'https://example/302',
    project: 'project-projecta',
    start: '2025-04-01',
    end: '2025-06-01',
    capacity: [{ team: 'team-team1', capacity: 70 }],
  },
  {
    id: 303,
    type: 'feature',
    ...
    state: 'Active',
    tags: 'Feature',
    description: 'Nested feature 2',
    startDate: '2025-04-15',
    finishDate: '2025-05-15',
    areaPath: 'ProjectA\\Team1',
    iterationPath: 'ProjectA',
    relations: [{ type: 'Parent', id: 302, url: 'https://example/302' }],
    url: 'https://example/303',
    project: 'project-projecta',
    start: '2025-04-15',
    end: '2025-05-15',
    capacity: [{ team: 'team-team1', capacity: 35 }],
  },
  ...
  // 4. Epic top-level, Epic child same project -> Epics move together but sizing is off
  {
    ...
    iterationPath: 'ProjectA',
    relations: [],
    url: 'https://example/400',
    project: 'project-projecta',
    start: '2025-05-01',
    end: '2025-09-01',
    capacity: [{ team: 'team-team1', capacity: 100 }],
  },
  {
    id: 401,
    type: 'epic',
    title: 'Epic child same',
    assignee: 'Jake',
    state: 'Active',
    tags: 'Epic',
    description: 'Epic child same',
    startDate: '2025-06-01',
    finishDate: '2025-07-01',
    areaPath: 'ProjectA\\Team1',
    iterationPath: 'ProjectA',
    relations: [{ type: 'Parent', id: 400, url: 'https://example/400' }],
    url: 'https://example/401',
    project: 'project-projecta',
    start: '2025-06-01',
    end: '2025-07-01',
    capacity: [{ team: 'team-team1', capacity: 50 }],
  },
  ...
  // 5. Epic top-level, Epic from different project -> Epics move together but sizing is off
  {
    id: 500,
    type: 'epic',
    title: 'Epic parent cross',
    assignee: 'Kim',
    state: 'New',
    tags: 'Epic',
    description: 'Epic parent cross',
    startDate: '2025-07-01',
    finishDate: '2025-10-01',
    areaPath: 'ProjectA\\Team1',
    iterationPath: 'ProjectA',
    relations: [],
    url: 'https://example/500',
    project: 'project-projecta',
    start: '2025-07-01',
    end: '2025-10-01',
    capacity: [{ team: 'team-team1', capacity: 85 }],
  },
  {
    id: 501,
    type: 'epic',
    title: 'Epic child cross',
    assignee: 'Liam',
    state: 'Active',
    tags: 'Epic',
    description: 'Epic child cross',
    startDate: '2025-07-15',
    finishDate: '2025-08-15',
    areaPath: 'ProjectB\\Team2',
    iterationPath: 'ProjectB',
    relations: [{ type: 'Parent', id: 500, url: 'https://example/500' }],
    url: 'https://example/501',
    project: 'project-projectb',
    start: '2025-07-15',
    end: '2025-08-15',
    capacity: [{ team: 'team-team2', capacity: 35 }],
  },
  ...
  // 6. Feature top-level, Feature child same project -> 601 not rendered
  {
    ...
    state: 'New',
    tags: 'Feature',
    description: 'Feature TL',
    startDate: '2025-09-01',
    finishDate: '2025-09-30',
    areaPath: 'ProjectA\\Team1',
    iterationPath: 'ProjectA',
    relations: [],
    url: 'https://example/600',
    project: 'project-projecta',
    start: '2025-09-01',
    end: '2025-09-30',
    capacity: [{ team: 'team-team1', capacity: 40 }],
  },
  {
    id: 601,
    type: 'feature',
    title: 'Feature child same2',
    assignee: 'Nate',
    state: 'Active',
    tags: 'Feature',
    description: 'Feature child same2',
    startDate: '2025-09-05',
    finishDate: '2025-09-20',
    areaPath: 'ProjectA\\Team1',
    iterationPath: 'ProjectA',
    relations: [{ type: 'Parent', id: 600, url: 'https://example/600' }],
    url: 'https://example/601',
    project: 'project-projecta',
    start: '2025-09-05',
    end: '2025-09-20',
    capacity: [{ team: 'team-team1', capacity: 20 }],
  },
  ...
  // 7. Feature top-level, Feature from different project -> 701 not rendered
  {
    id: 700,
    type: 'feature',
    title: 'Feature TL cross',
    assignee: 'Olga',
    state: 'New',
    tags: 'Feature',
    description: 'Feature TL cross',
  ...
  },
  {
    id: 701,
    type: 'feature',
    title: 'Feature child cross2',
    assignee: 'Pete',
    state: 'Active',
    tags: 'Feature',
    description: 'Feature child cross2',
    startDate: '2025-10-05',
    finishDate: '2025-10-20',
    areaPath: 'ProjectB\\Team2',
    iterationPath: 'ProjectB',
    relations: [{ type: 'Parent', id: 700, url: 'https://example/700' }],
  ...
  // 8. Circular reference: Epic_1 -> Feature_1 -> Epic_2 -> Epic_1 -> 802 not connected to 801 so they don't move together
  {
    ...
    state: 'New',
    tags: 'Epic',
    description: 'Circ epic 1',
    startDate: '2025-11-01',
    finishDate: '2025-12-01',
    areaPath: 'ProjectA\\Team1',
    iterationPath: 'ProjectA',
    relations: [{ type: 'Parent', id: 803, url: 'https://example/803' }],
    url: 'https://example/800',
    project: 'project-projecta',
    start: '2025-11-01',
    end: '2025-12-01',
    capacity: [{ team: 'team-team1', capacity: 75 }],
  },
  {
    id: 801,
    type: 'feature',
    title: 'Circ_Feature_1',
    assignee: 'Rita',
    state: 'Active',
    tags: 'Feature',
    description: 'Circ feature 1',
    startDate: '2025-11-05',
    finishDate: '2025-11-20',
    areaPath: 'ProjectA\\Team1',
    iterationPath: 'ProjectA',
    relations: [{ type: 'Parent', id: 800, url: 'https://example/800' }],
  ...
  },
  {
    ...
    state: 'New',
    tags: 'Epic',
    description: 'Circ epic 2',
    startDate: '2025-11-10',
    finishDate: '2025-11-30',
    areaPath: 'ProjectA\\Team1',
    iterationPath: 'ProjectA',
    relations: [{ type: 'Parent', id: 801, url: 'https://example/801' }],
  ...
  // loop back to 800
  {
    id: 803,
    type: 'epic',
    title: 'Circ_Epic_1_loop',
    assignee: 'Tara',
    state: 'Active',
    tags: 'Epic',
    description: 'Circ epic loop',
    startDate: '2025-11-15',
    finishDate: '2025-12-05',
    areaPath: 'ProjectA\\Team1',
    iterationPath: 'ProjectA',
    relations: [{ type: 'Parent', id: 802, url: 'https://example/802' }],
    url: 'https://example/803',
    project: 'project-projecta',
    start: '2025-11-15',
    end: '2025-12-05',
    capacity: [],
...
test('FeatureBoard handles various parent-child constellations without crashing', async ({
  page,
}) => {
