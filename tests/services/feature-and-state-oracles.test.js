...
describe('Feature Service and State Oracles (consolidated)', () => {
  describe('FeatureService unit behaviors', () => {
    ...
    it('getEffectiveFeatures applies overrides and sets dirty flags', () => {
      const baselineStore = {
        getFeatures: () => [
          { id: 10, start: '2025-01-01', end: '2025-01-10', title: 'Base' },
        ],
        getFeatureById: () =>
          new Map([
            {
      ...
      const activeScenario = {
        overrides: { 10: { start: '2025-01-02', end: '2025-01-09' } },
      };
    ...
    it('revertFeature removes override and returns true', () => {
      const baselineStore = {
        getFeatures: () => [{ id: 7, start: '2025-01-01', end: '2025-01-05' }],
        getFeatureById: () =>
          new Map([{ 7: { id: 7, start: '2025-01-01', end: '2025-01-05' } }]),
      };
      const activeScenario = {
        overrides: { 7: { start: '2025-01-02', end: '2025-01-06' } },
        isChanged: false,
      };
      const svc = new FeatureService(baselineStore, {
        getActiveScenario: () => activeScenario,
    ...
    it('getFeatureTitleById returns title or id', () => {
      const baselineStore = {
        getFeatures: () => [{ id: 99, title: 'NinetyNine' }],
        getFeatureById: () => new Map([[99, { id: 99, title: 'NinetyNine' }]]),
      };
      const svc = new FeatureService(baselineStore, () => null);
