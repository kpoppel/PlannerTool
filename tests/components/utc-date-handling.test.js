...
describe('UTC Date Handling - April 1st Bug', () => {
  ...
  describe('Position to date and back - full round trip', () => {
    ...
    function simulateComputePositionWithDSTBug(
      feature,
      months,
      monthWidth,
      boardOffset = 0
      ...
      const cachedMonthDays = months.map((m) =>
      ...
      const testCases = [
        {
          date: '2025-03-30',
          expectedMonthIdx: 2,
          desc: 'March 30 (before DST)',
        },
        { date: '2025-03-31', expectedMonthIdx: 2, desc: 'March 31 (DST day)' },
        {
          date: '2025-04-01',
          expectedMonthIdx: 3,
          desc: 'April 1 (after DST)',
        },
        {
          date: '2025-10-26',
          expectedMonthIdx: 9,
          desc: 'October 26 (before fall DST)',
        },
        {
          date: '2025-10-27',
          expectedMonthIdx: 9,
          desc: 'October 27 (fall DST)',
        },
      ];
