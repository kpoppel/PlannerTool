...
function mkFeature(id, type, start, end, parentEpic = null) {
...
baseline.set(
  'childA',
  mkFeature('childA', 'feature', '2025-12-05', '2025-12-10', 'epicA')
);
...
(async () => {
  ...
  console.log(
    'After epic move overrides',
    JSON.stringify(activeScenario.overrides, null, 2)
  );
})();
